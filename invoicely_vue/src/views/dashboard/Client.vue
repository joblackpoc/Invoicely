    ...
    <div class="page-client">
        <div class="columns is-multiline">
            <div class="column is-12">
                ...
                <router-link :to="{ name:'EditClient'}" class="button is-light mt-4">Edit</router-link>
            </div>

            <div class="column is-12">
                <h2 class="subtitle">Contact details</h2>
                <p><strong>{{ client.name }}</strong></p>
                <p v-if="client.address1">{{ client.addreess1 }}</p>
                <p v-if="client.address2">{{ client.addreess2 }}</p>
